...
const CanvasCore = defineAsyncComponent(() => import('@/components/CanvasCore.vue'))
const ToolCore = defineAsyncComponent(() => import('@/components/ToolCore.vue'))
</script>
